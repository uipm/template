  ...
  return (
    <>
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded">
        ...
        <div className="trezo-card-content relative h-[140px] lg:h-[245px] xl:h-[140px]">
          <div className="z-[2] relative text-center">
            <span className="text-lg font-bold">1</span> hrs{" "}
            <span className="text-lg font-bold">: 22</span> mins
          </div>
          <div className="left-0 right-0 -bottom-[53px] md:-bottom-[61px] absolute ltr:-ml-[32px] rtl:-mr-[32px] ltr:-mr-[30px] rtl:-ml-[30px] md:ltr:-ml-[37px] md:rtl:-mr-[37px] md:ltr:-mr-[35px] md:rtl:-ml-[35px]">
            {isChartLoaded && (
              <Chart
                options={options}
                series={series}
