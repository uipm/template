    ...
    <>
      <div className="relative rounded-md p-[20px] md:p-[25px] !pb-[65px] mb-[25px] border border-gray-100 dark:border-[#172036]">
        <div className="flex items-center">
          <div className="bg-primary-100 text-white text-center relative z-[1] ltr:mr-[15px] rtl:ml-[15px] rounded-[5px] text-[25px] w-[55px] h-[55px]">
            <span className="inset-0 -z-[1] m-[8px] absolute rounded-[5px] bg-primary-500"></span>
            <i className="ri-shopping-cart-line absolute left-0 right-0 top-1/2 -translate-y-1/2"></i>
          </div>
          <div>
