...
const TopInstructors: React.FC = () => {
  ...
  const totalPages = Math.ceil(initialInstructors.length / ITEMS_PER_PAGE);

  const displayedInstructors = initialInstructors.slice(
      ...
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="trezo-card-header mb-[20px] md:mb-[25px] flex items-center justify-between">
          <div className="trezo-card-title">
            <h5 className="mb-0">Top Instructors</h5>
          </div>
            ...
            <div className="flex items-center">
              <p className="mb-0 text-sm">
                ...
                {Math.min(
                  ...
                  initialInstructors.length
                )}{" "}
                of {initialInstructors.length}
              </p>
