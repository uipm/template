      ...
      >
        <div className="trezo-card-header py-[15px] px-[20px] md:px-[25px] flex items-center justify-between">
          <div className="trezo-card-title">
            <h5 className="mb-0 text-white text-md font-medium">
              Average Order Value
            </h5>
          </div>
        ...
        <div className="trezo-card-content bg-white dark:bg-[#15203c] rounded-[4px] p-[20px] md:p-[25px] border-t border-gray-100 dark:border-[#172036]">
          <div className="flex items-center justify-between">
            <h3 className="font-semibold mb-0 text-[22px] md:text-xl">$40</h3>
            <div className="flex items-center justify-center w-[51px] h-[51px] bg-success-100 dark:bg-dark rounded-full">
              <Image
                src="/images/icons/check-cart.svg"
                alt="check-cart"
                width={26}
                height={26}
              />
          ...
          <div className="relative mt-[15px] ltr:pl-[29px] rtl:pr-[29px]">
            <i className="material-symbols-outlined absolute ltr:left-0 rtl:right-0 !text-[20px] text-danger-500 top-1/2 -translate-y-1/2">
              trending_down
            </i>
