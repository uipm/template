    ...
    <>
      <div className="trezo-card bg-white dark:bg-[#0c1427] mb-[25px] p-[20px] md:p-[25px] rounded-md">
        <div className="trezo-card-content">
          <div className="md:flex items-center justify-between mb-[20px] md:mb-[25px]">
            <div>
              <span className="block md:text-[15px] mb-[15px] md:mb-[25px]">
                Invoice Number:
                <span className="text-black dark:text-white">#1346</span>
              </span>
              <span className="block mb-[4px] md:text-[15px]">Invoice To:</span>
              <span className="block mb-[4px] md:text-[15px] text-black dark:text-white">
                Shannon Nelson
              </span>
              <span className="block mb-[4px] md:text-[15px] text-black dark:text-white">
            ...
            <div className="ltr:md:text-right rtl:md:text-left">
              <span className="block md:text-[15px] mb-[15px] md:mb-[25px]">
                Date:
                <span className="text-black dark:text-white">01 Dec 2024</span>
              </span>
              <span className="block mb-[4px] md:text-[15px]">Pay To:</span>
              <span className="block mb-[4px] md:text-[15px] text-black dark:text-white">
                Mercedes Foreman
              </span>
              <span className="block mb-[4px] md:text-[15px] text-black dark:text-white">
