document.addEventListener("turbo:load", () => {
	(function () {
		...
		if (getLeadsbySourcId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#leads_by_sourc"),
				options
			);
			chart.render();
		}
		...
		if (getStatus6Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#status6"),
				options
			);
			chart.render();
		}
		...
		if (getStatus72Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#status7"),
				options
			);
			chart.render();
		}
		...
		if (getStatus82Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#status8"),
				options
			);
			chart.render();
		}
		...
		if (getStatus92Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#status9"),
				options
			);
			chart.render();
		}
		...
		if (getStatus102Id) {
			...
			var chart = new ApexCharts(
				document.querySelector("#status10"),
				options
			);
			chart.render();
		}
		...
		if (getNewTicketsvsSolvedTicketsId) {
			...
			var chart = new ApexCharts(
				document.querySelector("#new_tickets_vs_solved_sickets"),
				options
			);
			chart.render();
		}
