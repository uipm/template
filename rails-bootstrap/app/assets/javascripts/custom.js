document.addEventListener("turbo:load", () => {
	(function () {
		...
		try {
			document
				.getElementById("sweetalert_1")
				.addEventListener("click", function (e) {
					Swal.fire("Good job!");
				});

			document
				.getElementById("sweetalert_2")
				.addEventListener("click", function (e) {
					Swal.fire("Here's the title!", "...and here's the text!");
				});

			document
				.getElementById("sweetalert_3")
				.addEventListener("click", function (e) {
					Swal.fire(
						"Good job!",
			...
			document
				.getElementById("sweetalert_4")
				.addEventListener("click", function (e) {
					Swal.fire("Good job!", "You clicked the button!", "error");
				});

			document
				.getElementById("sweetalert_5")
				.addEventListener("click", function (e) {
					Swal.fire(
						"Good job!",
						"You clicked the button!",
			...
			document
				.getElementById("sweetalert_6")
				.addEventListener("click", function (e) {
					Swal.fire("Good job!", "You clicked the button!", "info");
				});

			document
				.getElementById("sweetalert_7")
				.addEventListener("click", function (e) {
					Swal.fire(
						"Good job!",
						"You clicked the button!",
			...
			document
				.getElementById("sweetalert_14")
				.addEventListener("click", function (e) {
					Swal.fire({
						title: "Sweet!",
						text: "Modal with a custom image.",
						imageUrl:
							"https://camo.envatousercontent.com/5b57b814db32f74f4ce750680390a407898cc665/68747470733a2f2f696d616765732e656e76797468656d652e636f6d2f72656163742d76657273696f6e2d617661696c61626c652e6a7067",
						imageWidth: 400,
						imageHeight: 200,
		...
		if (getBoxedToggleId) {
			...
			if (savedTheme) {
				document.body.setAttribute(
					"boxed-style-data-theme",
					savedTheme
				);
			}
			switchtoggle.addEventListener("click", function () {
				if (
					document.body.getAttribute("boxed-style-data-theme") ===
					"boxed-style-fluid"
				) {
					document.body.setAttribute(
						"boxed-style-data-theme",
