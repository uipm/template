		...
		return (function (t) {
			...
			function (t, e, n) {
				...
				function l(t, e) {
					...
					var r = Object.keys(n.modules).concat(
							Object.keys(e.modules)
						),
							...
							h(t, [
								{
									...
									value: function (t) {
										...
										return (
											this.container.insertBefore(t, e), t
										);
									},
								},
								{
					...
					s = (function (t) {
						...
						return (
							...
							(e.prototype.replaceWith = function (e, n) {
								var r = t.prototype.replaceWith.call(
									this,
									e,
									n
								);
					...
					l = {
						attributes: {
							...
							transform: function (t, e, n) {
								...
								if ("object" == typeof e) {
									if (!n) return e;
									var r = Object.keys(e).reduce(function (
										n,
										r
									) {
										return (
			...
			function (t, e) {
				var n = (function () {
						...
						function f(n, o) {
							...
							if (t(n, a)) y = new a();
								...
								if (d && Buffer.isBuffer(n))
									return (
										(y = new Buffer(n.length)), n.copy(y), y
									);
								t(n, Error)
									? (y = Object.create(n))
									: void 0 === i
					...
					function o(t) {
						return (
							"object" == typeof t && "[object Array]" === n(t)
						);
					}
					function i(t) {
						return (
							"object" == typeof t && "[object RegExp]" === n(t)
						);
					}
					function l(t) {
						var e = "";
							...
							s(t, [
								...
								},
								{
									...
									value: function (t) {
										...
										return (
											[e.start, e.end].forEach(function (
												t
											) {
												for (
													var e = t.node,
			...
			function (t, e, n) {
				...
				function y(t) {
					...
					return (
						t.shortKey && ((t[B] = t.shortKey), delete t.shortKey),
						t
					);
				}
				Object.defineProperty(e, "__esModule", { value: !0 }),
				...
				var v =
					...
					D = (function (t) {
						function e(t, n) {
							...
							return (
								(r.bindings = {}),
								Object.keys(r.options.bindings).forEach(
									function (e) {
										("list autofill" !== e ||
					...
					o = (function () {
						...
						return (
							...
							(t.prototype.replaceWith = function (t, e) {
								var n =
									"string" == typeof t ? r.create(t, e) : t;
							...
							a(e, [
								...
								},
								{
									...
									value: function (t) {
										...
										if (t === this.leftGuard)
											if (
												this.prev instanceof h.default
											) {
									...
									null == r.tooltip ||
										...
										null != r.pickers &&
											r.pickers.forEach(function (t) {
												t.container.contains(
													n.target
												) || t.close();
											});
								};
							return (
								t.emitter.listenDOM("click", document.body, l),
								r
							);
						}
						return (
			...
			function (t, e) {
				...
				Object.create &&
					...
					(o.prototype.listeners = function (t, e) {
						...
						if (r.fn) return [r.fn];
						for (
							var o = 0, i = r.length, a = new Array(i);
							o < i;
							o++
						)
							a[o] = r[o].fn;
					...
					(o.prototype.emit = function (t, e, n, r, o, i) {
						...
						if (c.fn) {
							switch (
								...
								case 6:
									return (
										c.fn.call(c.context, e, n, r, o, i), !0
									);
							}
			...
			function (t, e, n) {
				...
				function g(t, e) {
					...
					for (
						...
						"list" === (P.default.query(o) || {}).blotName &&
							(r += 1),
							(o = o.parentNode);
					return r <= 0
						? e
				...
				function _(t, e) {
					if (f(t) && null != t.nextElementSibling && !c(e, "\n\n")) {
						...
						t.nextElementSibling.offsetTop >
							t.offsetTop + 1.5 * n && e.insert("\n");
					}
					return e;
				}
				function O(t, e) {
				...
				var x =
					...
					Y = [B.AlignAttribute, K.DirectionAttribute].reduce(
						function (t, e) {
					...
					$ = (function (t) {
						function e(t, n) {
							...
							return (
								...
								(r.matchers = []),
								G.concat(r.options.matchers).forEach(function (
									t
								) {
									var e = k(t, 2),
										o = e[0],
							...
							l(e, null, [
								{
									...
									value: function (t) {
										return (
											this.tagName.indexOf(t.tagName) + 1
										);
									},
								},
							]),
					...
					k = (function (t) {
						function e(t, n) {
							...
							return (
								...
								(r.controls = []),
								(r.handlers = {}),
								Object.keys(r.options.handlers).forEach(
									function (t) {
								...
								r.quill.on(
									...
									function (t, e) {
										t ===
											g.default.events.SELECTION_CHANGE &&
											r.update(e);
									}
								),
								r.quill.on(
				...
				var a = (function () {
					...
					w = (function (t) {
						function e(t, n) {
							...
							return (
								r.quill.container.classList.add("ql-snow"), r
							);
						}
						return (
							l(e, t),
