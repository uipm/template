...
document.addEventListener("turbo:load", () => {
	!(function (t, e) {
		...
		var b,
			...
			j = g(function (t) {
				...
				(t.exports = function (t, i) {
					...
					mode: "global",
					copyright:
						"ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© 2019 Denis Pushkarev (zloirock.ru)",
				});
			}),
			C = 0,
			N = Math.random(),
			...
			$t =
				...
				e(function () {
					...
					return (
						...
						7 != Ft({}, t)[i] ||
							"abcdefghijklmnopqrst" != qt(Ft({}, e)).join("")
					);
				})
					? function (t, e) {
							for (
		...
		var Yt =
				"\t\n\v\f\r ÃƒÆ’Ã¢â‚¬Å¡ ÃƒÆ’Ã‚Â¡Ãƒâ€¦Ã‚Â¡ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚ÂÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬ ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¹Ã¢â‚¬ ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦ ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¯ÃƒÆ’Ã‚Â¢Ãƒâ€šÃ‚ÂÃƒâ€¦Ã‚Â¸ÃƒÆ’Ã‚Â£ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬\u2028\u2029\ufeff",
			Xt = "[" + Yt + "]",
			Gt = RegExp("^" + Xt + Xt + "*"),
			Kt = RegExp(Xt + Xt + "*$"),
			Ut = E.parseInt,
			...
			return [
				...
				function (t) {
					...
					for (var a, l = [], c = 0; null !== (a = le(n, s)); ) {
						...
						(l[c] = u),
							"" === u &&
								(n.lastIndex = ae(s, f(n.lastIndex), o)),
							c++;
					}
					return 0 === c ? null : l;
				},
			...
			return [
				...
				function (t, n) {
					...
					for (var d = []; ; ) {
						...
						if ((d.push(p), !c)) break;
						"" === String(p[0]) &&
							(o.lastIndex = ae(a, f(o.lastIndex), h));
					}
		...
		var Bi = 20,
			...
			Fi = function (t) {
				return (
					(t && t.ownerDocument && t.ownerDocument.defaultView) || zi
				);
			},
			$i = Ji(0, 0, 0, 0);
		function Yi(t) {
				...
				(this.onScroll = function () {
					...
					(this.onEndDrag = function (t) {
						t.preventDefault(),
							...
							(r.removePreventClickId = window.setTimeout(
								function () {
									document.removeEventListener(
										"click",
										r.preventClick,
				...
				(e.recalculate = function () {
					...
					(this.elStyles = window.getComputedStyle(this.el)),
						...
						(this.wrapperEl.style.margin =
							...
							" -" +
							this.elStyles.paddingLeft),
						(this.contentWrapperEl.style.height = t
							? "auto"
							: "100%"),
