	...
	var SegHierarchy = /** @class */ (function () {
		...
		SegHierarchy.prototype.findInsertion = function (newEntry) {
			...
			for (var level = 0; level < levelCnt; level += 1) {
				...
				if (
					!strictOrder &&
					levelCoord >= resLevelCoord + newEntry.thickness
				) {
					break;
				}
				...
				while (
					...
					if (
						strictOrder || // strict-mode doesn't care about vert intersection. record touch and keep pushing down // vertically intersects?
			...
			return {
				...
				stackCnt: touchingEntry
					? stackCnts[buildEntryKey(touchingEntry)] + 1
					: 0,
			};
		};
		...
		SimpleScrollGrid.prototype.render = function () {
			...
			return createElement(
				...
				Boolean(!isBuggy && headSectionNodes.length) &&
					createElement.apply(
						void 0,
						__spreadArray(["thead", {}], headSectionNodes)
					),
				Boolean(!isBuggy && bodySectionNodes.length) &&
					createElement.apply(
						void 0,
						__spreadArray(["tbody", {}], bodySectionNodes)
					),
				...
				isBuggy &&
					createElement.apply(
						...
						__spreadArray(
							__spreadArray(
								__spreadArray(["tbody", {}], headSectionNodes),
								bodySectionNodes
							),
							footSectionNodes
						)
				...
				for (
					...
					if (this.allowReslicing) {
						...
						if (!forceHidden[placeholderEntryId]) {
							...
							entriesByLevel[touchingLevel][lateral] =
								placeholderEntry; // replace leadingEntry with our placeholder
