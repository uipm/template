	...
	!(function (t, e) {
				...
				if (
					(this._config.parent &&
						(t = this._getFirstLevelChildren(
							...
							.map((t) =>
								Bt.getOrCreateInstance(t, { toggle: !1 })
							)),
		...
		function Te(t, e, i) {
			...
			e &&
				...
				(o =
					(t.offsetHeight > 0 && we(n.height) / t.offsetHeight) ||
					1));
		...
		function ii(t, e) {
			...
			var i = e,
				...
				w = (function (t, e, i, n) {
					...
					pe(y) ? y : y.contextElement || Le(t.elements.popper),
					l,
					h,
					r
				),
