...
document.addEventListener("turbo:load", () => {
	!(function (t, e) {
					...
					((t, e) => {
						...
						if (o) {
							...
							if (e.icon || e.iconHtml) {
								if (
									e.icon &&
									-1 === Object.keys(c).indexOf(e.icon)
								)
									return (
										p(
		...
		const se = (t) => {
			...
			ce = (t, e, n, o, s) => {
				dt &&
					((i.swalCloseEventFinishedCallback = ee.bind(
						null,
						t,
						n,
						o,
		...
		var pn = Object.freeze({
			...
			bindClickHandler: function () {
				(un[
					...
					ln ||
						(document.body.addEventListener("click", dn),
						(ln = !0));
			},
			clickCancel: () => {
				var t;
		...
		const gn = ["swal-title", "swal-html", "swal-footer"],
			...
			fn = (t) => {
				...
				return (
					Array.from(
						t.querySelectorAll("swal-function-param")
					).forEach((t) => {
						const n = t.getAttribute("name"),
							o = t.getAttribute("value");
