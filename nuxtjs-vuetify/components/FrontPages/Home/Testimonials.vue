      ...
      <div class="row justify-content-center">
          ...
          <div class="single-testimonial-item bg-white border-radius">
            ...
            <div class="info d-flex align-items-center">
              ...
              <div>
                ...
                <span class="d-block"> Marketing Director </span>
              </div>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4">
          <div class="single-testimonial-item bg-white border-radius">
            ...
            <p>
              ...
              deeper understanding of our business metrics and identify areas
              for improvement. The responsive support team is a bonus, we are
          ...
          <div class="single-testimonial-item bg-white border-radius">
            ...
            <div class="info d-flex align-items-center">
              ...
              <div>
                ...
                <span class="d-block"> Marketing Coordinator </span>
              </div>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4">
          <div class="single-testimonial-item bg-white border-radius">
            ...
            <div class="info d-flex align-items-center">
              <v-img
                src="~/assets/images/front-pages/user6.jpg"
                class="rounded-circle"
                alt="user-image"
              />
              <div>
                <h5 class="fw-semibold">Daniel Lee</h5>
                <span class="d-block"> Co-founder, StartupX </span>
              </div>
            </div>
          </div>
        </div>
