      ...
      <nav class="navbar navbar-expand-lg">
        ...
        >
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <NuxtLink to="/team" class="nav-link"> Our Team </NuxtLink>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <NuxtLink to="/dashboard" class="nav-link"> Admin </NuxtLink>
            </li>
          </ul>
          <div class="other-options d-flex align-items-center">
            <NuxtLink class="btn" to="/authentication/sign-in">
              <i class="material-symbols-outlined"> login </i>
              Login
            </NuxtLink>
            <NuxtLink class="btn" to="/authentication/sign-up">
