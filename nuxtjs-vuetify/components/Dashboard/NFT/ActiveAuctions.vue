              ...
              <td class="border-bottom">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-2">
                    ...
                    <span class="fs-12 text-body">by John Lira</span>
                  </div>
                </div>
              </td>
              <td class="fs-12 border-bottom fw-semibold text-body">
                11.75 ETH
              </td>
              <td class="fs-12 border-bottom fw-semibold text-body">
                10.00 ETH
              ...
              <td class="border-bottom">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-2">
                    ...
                    <span class="fs-12 text-body">by WalterW.</span>
                  </div>
                </div>
              </td>
              <td class="fs-12 border-bottom fw-semibold text-body">
              ...
              <td class="border-bottom">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-2">
                    ...
                    <span class="fs-12 text-body">by Christino</span>
                  </div>
                </div>
              </td>
              <td class="fs-12 border-bottom fw-semibold text-body">
              ...
              <td class="border-bottom">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-2">
                    ...
                    <span class="fs-12 text-body">by Hater</span>
                  </div>
                </div>
              </td>
              <td class="fs-12 border-bottom fw-semibold text-body">
              ...
              <td class="border-bottom">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-2">
                    ...
                    <span class="fs-12 text-body">by Liveslong</span>
                  </div>
                </div>
              </td>
              <td class="fs-12 border-bottom fw-semibold text-body">
