<template>
  <v-card
    class="new-tickets-solved-tickets-card trezo-card border-radius d-block bg-white border-0 shadow-none"
  >
    <div class="v-card-header">
      <h5 class="mb-0 fw-semibold">New Tickets vs Solved Tickets</h5>
      <v-menu>
