          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="trezo-form-group">
                ...
                <v-select
                  v-model="productType"
                  label="Select"
                  :items="['Digital Product', 'Physical Product']"
                ></v-select>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="trezo-form-group">
                <v-label class="d-block fw-medium text-black"> SKU </v-label>
                <v-text-field
                  v-model="sku"
                  label="Enter sku"
            ...
            <div class="col-sm-6">
              <div class="trezo-form-group">
                ...
                <v-select
                  v-model="brandName"
                  label="Select"
                  :items="['Emburo', 'Fediz', 'Debilop', 'Canin', 'Daxa']"
                ></v-select>
              </div>
            </div>
            <div class="col-sm-12">
              <div class="trezo-form-group">
                ...
                <CommonTextEditor v-model="productDescription" />
              </div>
            </div>
            <div class="col-sm-6">
              <div class="trezo-form-group">
            ...
            <div class="col-sm-12">
              <div class="trezo-form-group mb-0">
                ...
                <CommonFileUploader v-model="productImages" />
              </div>
            </div>
          </div>
        </v-card>
      ...
      <v-col cols="12" lg="4">
        ...
        >
          ...
          <div class="row">
            <div class="col-lg-12 col-sm-6">
              <div class="trezo-form-group">
                ...
                <v-select
                  v-model="category"
                  label="Select"
                  :items="['Watch', 'Mobile', 'Laptop', 'Headphone', 'Shoe']"
                ></v-select>
              </div>
            </div>
            <div class="col-lg-12 col-sm-6">
              <div class="trezo-form-group">
                <v-label class="d-block fw-medium text-black"> Vendor </v-label>
                <v-select
                  v-model="vendor"
                  label="Select"
                  :items="[
            ...
            <div class="col-lg-12 col-sm-6">
              <div class="trezo-form-group mb-0">
                <v-label class="d-block fw-medium text-black"> Tags </v-label>
                <v-select
                  v-model="favorites"
                  label="Select"
                  multiple
        ...
        >
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="trezo-form-group">
                <v-label class="d-block fw-medium text-black"> Title </v-label>
                <v-text-field
                  v-model="title"
                  label="Enter title"
                  placeholder="E.g. Google Pixel 7 Pro"
...
export default {
  ...
  data() {
    return {
      favorites: [],
      states: ["Watch", "Electronics", "Sports", "Fashion", "Jewellery"],
