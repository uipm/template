<template>
  <v-row>
    <v-col cols="12" lg="8">
      <v-card
        class="your-order-card trezo-card border-radius d-block bg-white border-0 shadow-none"
      >
              ...
              <v-table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <PagesEcommerceCartQuantityCounter value="1" />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <PagesEcommerceCartQuantityCounter value="3" />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <PagesEcommerceCartQuantityCounter value="7" />
                    </td>
