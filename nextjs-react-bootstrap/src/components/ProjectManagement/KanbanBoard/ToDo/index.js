        ...
        <Card.Body className="p-4">
          ...
          >
            ...
            <div className="d-flex align-items-center justify-content-between pt-1">
              ...
              <span className="text-primary">5 days left</span>
            </div>
          </div>
          ...
          >
            <div className="d-flex justify-content-between align-items-center mb-3">
              <h4 className="mb-0 fs-14 fw-semibold">WordPress Theme</h4>
              <button className="fs-20 text-body hover border-0 p-0 bg-transparent">
                <MaterialSymbol icon="edit" />
              </button> 
            </div>
          ...
          >
            ...
            <div className="d-flex align-items-center justify-content-between pt-1">
              ...
              <span className="text-primary">10 days left</span>
            </div>
          </div>
          ...
          >
            <div className="d-flex justify-content-between align-items-center mb-3">
              <h4 className="mb-0 fs-14 fw-semibold">Project Analysis</h4>
              <button className="fs-20 text-body hover border-0 p-0 bg-transparent">
                <MaterialSymbol icon="edit" />
              </button> 
            </div>
          ...
          >
            <div className="d-flex justify-content-between align-items-center mb-3">
              <h4 className="mb-0 fs-14 fw-semibold">Competitor Research</h4>
              <button className="fs-20 text-body hover border-0 p-0 bg-transparent">
                <MaterialSymbol icon="edit" />
              </button> 
            </div>
            ...
            <div className="d-flex align-items-center justify-content-between pt-1">
              ...
              <span className="text-primary">15 days left</span>
            </div>
          </div>
