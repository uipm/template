          ...
          >
            ...
            <div className="othres">
              <Link
                ...
                className="btn btn-outline-primary-div py-2 px-4 fw-medium fs-16 rounded-3"
              >
                <i className="ri-login-box-line fs-18 position-relative top-2"></i>
                <span className="ms-1">Login</span>
              </Link>

              <Link
                href="/authentication/sign-up/"
                className="btn btn-primary-div py-2 px-4 fw-medium fs-16 text-white ms-3 rounded-3"
              >
