              ...
              <Table className="align-middle">
                <thead>
                  <tr>
                    ...
                    <th scope="col" className="text-end">No. Order Returned</th>
                    <th scope="col" className="text-end">No. Order Refunded</th>
                    <th scope="col" className="text-end">No. Order Replaced</th>
                    <th scope="col" className="text-end">Total Refunded	</th>
                    <th scope="col" className="text-end">Total Replaced</th>
                  </tr>
                </thead>
                <tbody>
                  {refundsData &&
