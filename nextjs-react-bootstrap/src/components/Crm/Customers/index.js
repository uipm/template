        ...
        <Card.Body className="p-0">
          <div className="p-4">
            <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
              ...
              <Form.Select className="month-select form-control" aria-label="Default select example">
                  ...
                  {customersData &&
                    customersData.slice(0, 10).map((value, i) => (
                      <tr key={i}>
                        ...
                        <td className="text-body">{value.received}</td>

                        <td className="text-body">{value.due}</td>
