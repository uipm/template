(function() {
    ...
    // Status 1 JS
	const getStatus1Id = document.getElementById('status1');
	if (getStatus1Id) {
		var options = {
			chart: {
				height: 100,
    ...
    // Status 2 JS
	const getStatus2Id = document.getElementById('status2');
	if (getStatus2Id) {
		var options = {
			chart: {
				height: 100,
    ...
    // Status 3 JS
	const getStatus3Id = document.getElementById('status3');
	if (getStatus3Id) {
		var options = {
			chart: {
				height: 100,
    ...
    // Status 4 JS
	const getStatus4Id = document.getElementById('status4');
	if (getStatus4Id) {
		var options = {
			chart: {
				height: 100,
    ...
    // Status 5 JS
	const getStatus5Id = document.getElementById('status5');
	if (getStatus5Id) {
		var options = {
			chart: {
				height: 100,
		...
		var chart = new ApexCharts(document.querySelector("#status5"), options);
		chart.render()
	}

    // Status 6 JS
	const getStatus6Id = document.getElementById('status6');
	if (getStatus6Id) {
		var options = {
			chart: {
				height: 100,
		...
		document.querySelector("#status6").innerHTML = ""
		var chart = new ApexCharts(document.querySelector("#status6"), options);
		chart.render()
	}

	// Status 7 JS
	const getStatus72Id = document.getElementById('status7');
	if (getStatus72Id) {
		var options = {
			chart: {
				height: 100,
		...
		document.querySelector("#status7").innerHTML = ""
		var chart = new ApexCharts(document.querySelector("#status7"), options);
		chart.render()
	}

    // Status 8 JS
	const getStatus82Id = document.getElementById('status8');
	if (getStatus82Id) {
		var options = {
			chart: {
				height: 100,
		...
		document.querySelector("#status8").innerHTML = ""
		var chart = new ApexCharts(document.querySelector("#status8"), options);
		chart.render()
	}

    // Status 9 JS
	const getStatus92Id = document.getElementById('status9');
	if (getStatus92Id) {
		var options = {
			chart: {
				height: 100,
		...
		document.querySelector("#status9").innerHTML = ""
		var chart = new ApexCharts(document.querySelector("#status9"), options);
		chart.render()
	}

    // Status 10 JS
	const getStatus102Id = document.getElementById('status10');
	if (getStatus102Id) {
		var options = {
			chart: {
				height: 100,
		...
		document.querySelector("#status10").innerHTML = ""
		var chart = new ApexCharts(document.querySelector("#status10"), options);
		chart.render()
	}
