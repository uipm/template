                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
                        ...
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb align-items-center mb-0 lh-1">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span class="fw-medium">assets-manager</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                                    ...
                                    <ul class="ps-0 mb-0 list-unstyled">
                                        <li class="mb-4">
                                            ...
                                            <ul class="mb-0 list-unstyled file-subdown">
                                                <li>
                                                    <a href="assets-manager" class="text-decoration-none text-primary">assets-manager</a>
                                                </li>
                                                <li>
                                ...
                                <div class="col-xxl-3 col-xl-6 col-sm-6">
                                    <div class="card bg-white border-0 rounded-3 mb-4">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-flex align-items-center py-4 my-3">
                                                <i class="material-symbols-outlined fs-45 text-success">folder_open</i>
                                ...
                                <div class="col-xxl-3 col-xl-6 col-sm-6">
                                    <div class="card bg-white border-0 rounded-3 mb-4">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-flex align-items-center py-4 my-3">
                                                <i class="material-symbols-outlined fs-45 text-danger">folder_open</i>
                                ...
                                <div class="col-xxl-3 col-xl-6 col-sm-6">
                                    <div class="card bg-white border-0 rounded-3 mb-4">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-flex align-items-center py-4 my-3">
                                                <i class="material-symbols-outlined fs-45 text-warning">folder_open</i>
                                ...
                                <div class="col-xxl-3 col-xl-6 col-sm-6">
                                    <div class="card bg-white border-0 rounded-3 mb-4">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-flex align-items-center py-4 my-3">
                                                <i class="material-symbols-outlined fs-45 text-info">folder_open</i>
                                ...
                                <div class="col-xxl-3 col-xl-6 col-sm-6">
                                    <div class="card bg-white border-0 rounded-3 mb-4">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-flex align-items-center py-4 my-3">
                                                <i class="material-symbols-outlined fs-45 text-secondary">folder_open</i>
                                ...
                                <div class="col-xxl-3 col-xl-6 col-sm-6">
                                    <div class="card bg-white border-0 rounded-3 mb-4">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="d-flex align-items-center py-4 my-3">
                                                <i class="material-symbols-outlined fs-45 text-warning text-opacity-10">folder_open</i>
