			...
			<div class="main-content d-flex flex-column">
				...
				<div class="main-content-container overflow-hidden">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
                        <h3 class="mb-0">Date Time Picker</h3>
                        ...
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb align-items-center mb-0 lh-1">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span class="fw-medium">Date Time Picker</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                                        ...
                                        <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel" aria-labelledby="preview-tab" tabindex="0">
                                            <div class="form-group mb-0">
                                                ...
                                                <div class="form-group position-relative">
                                                    <input type="time" class="form-control h-55 text-dark ps-5 h-58">
                                                    <i class="ri-time-line position-absolute top-50 translate-middle-y fs-20 text-gray-light ps-20"></i>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-content" id="myTabContent2">
                                        <div class="tab-pane fade show active" id="preview2-tab-pane" role="tabpanel" aria-labelledby="preview2-tab" tabindex="0">
                                            <div class="form-group mb-0">
                                                ...
                                                <div class="form-group position-relative">
                                                    <input type="date" class="form-control h-55 text-dark ps-5 h-58">
