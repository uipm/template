                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
                        ...
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb align-items-center mb-0 lh-1">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span class="fw-medium">Edit Course</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" class="form-control h-55 text-secondary" value="E.g. Cybersecurity Awareness">
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group mb-4">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" class="form-control h-55 text-secondary" value="E.g. $90">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <select class="form-select form-control text-dark h-55 cursor" aria-label="Default select example">
                                                        <option selected>Olivia Clark</option>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <form>
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control h-55" value="E.g. Course Overview">
                                        </div>
                                        <div class="form-group mb-4">
                                        ...
                                        <div class="form-group mb-4">
                                            <label class="label text-secondary">E.g. It makes me feel...</label>
