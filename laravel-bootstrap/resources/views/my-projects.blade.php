			...
			<div class="main-content d-flex flex-column">
				...
				<div class="main-content-container overflow-hidden">
                    ...
                    <div class="d-flex justify-content-center flex-wrap gap-2 mb-4">
                        <a href="user-profile" class="btn btn-outline-primary py-2 px-3 fw-medium">Profile</a>
                        <a href="teams-2" class="btn btn-outline-primary py-2 px-3 fw-medium">Team</a>
                        <a href="my-projects" class="btn btn-primary py-2 px-3 fw-medium">Projects</a>
                    </div>
                                    ...
                                    <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap">
                                        ...
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination mb-0 justify-content-center">
                                                <li class="page-item">
                                                    <a class="page-link icon" href="my-projects" aria-label="Previous">
                                                        <i class="material-symbols-outlined">keyboard_arrow_left</i>
                                                    </a>
                                                </li>
                                                <li class="page-item"><a class="page-link active" href="my-projects">1</a></li>
                                                <li class="page-item"><a class="page-link" href="my-projects">2</a></li>
                                                <li class="page-item"><a class="page-link" href="my-projects">3</a></li>
                                                <li class="page-item"><a class="page-link" href="my-projects">4</a></li>
                                                <li class="page-item">
                                                    <a class="page-link icon" href="my-projects" aria-label="Next">
