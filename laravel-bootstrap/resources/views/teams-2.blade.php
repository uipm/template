			...
			<div class="main-content d-flex flex-column">
				...
				<div class="main-content-container overflow-hidden">
                    ...
                    <div class="d-flex justify-content-center flex-wrap gap-2 mb-4">
                        ...
                        <a href="teams-2" class="btn btn-primary py-2 px-3 fw-medium">Team</a>
                                    ...
                                    <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap">
                                        ...
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination mb-0 justify-content-center">
                                                <li class="page-item">
                                                    <a class="page-link icon" href="teams-2" aria-label="Previous">
                                                        <i class="material-symbols-outlined">keyboard_arrow_left</i>
                                                    </a>
                                                </li>
                                                <li class="page-item"><a class="page-link active" href="teams-2">1</a></li>
                                                <li class="page-item"><a class="page-link" href="teams-2">2</a></li>
                                                <li class="page-item"><a class="page-link" href="teams-2">3</a></li>
                                                <li class="page-item"><a class="page-link" href="teams-2">4</a></li>
                                                <li class="page-item">
                                                    <a class="page-link icon" href="teams-2" aria-label="Next">
