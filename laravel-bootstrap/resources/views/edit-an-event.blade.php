                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
                        ...
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb align-items-center mb-0 lh-1">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span class="fw-medium">Edit An Event</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control h-55" value="E.g. Annual Conference 2024">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="form-group mb-4">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control h-55" value="Enter ticket price">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="form-group mb-4">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <select class="form-select form-control h-55" aria-label="Default select example">
                                                <option selected>Pepper Festival</option>
                                                <option value="1">Select</option>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control h-55" value="Enter event vanue">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="form-group mb-4">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control h-55" value="E.g. Hand Watch">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group mb-4">
