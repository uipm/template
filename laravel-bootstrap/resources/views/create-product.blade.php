                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
                        ...
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb align-items-center mb-0 lh-1">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span class="fw-medium">Create Product</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" class="form-control h-55" placeholder="Enter product title">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" class="form-control h-55" placeholder="Enter SKU">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="form-group mb-4">
                                            ...
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" class="form-control h-55" placeholder="Enter regular price">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="form-group mb-4">
                                                    <label class="label text-secondary">Sale Price</label>
                                                    <input type="text" class="form-control h-55" placeholder="Enter sale price">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="form-group mb-4">
                                            ...
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" class="form-control h-55" placeholder="Enter product in stock">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="form-group mb-4">
                                                    <label class="label text-secondary">Product ID</label>
                                                    <input type="text" class="form-control h-55" placeholder="Enter product id">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-sm-12">
                                                <div class="form-group mb-4">
                                                    <label class="label text-secondary">Discount / Offer</label>
                                                    <input type="text" class="form-control h-55" placeholder="Enter discount / Offer">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="form-group mb-4">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <form>
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control h-55" placeholder="Enter title">
                                        </div>
                                        <div class="form-group mb-0">
