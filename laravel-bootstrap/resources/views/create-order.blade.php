				...
				<div class="main-content-container overflow-hidden">
                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea rows="7" class="form-control" placeholder="Write your note here...."></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                        ...
                        <div class="col-xxl-4 col-lg-5">
                            <div class="card bg-white border-0 rounded-3 mb-4">
                                <div class="card-body p-4">
                                    <h3 class="mb-3 mb-lg-4">Your Order</h3>
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="text-secondary">Ordered items</span>
                                        <a href="cart" class="text-primary text-decoration-none">Edit Cart </a>
                                    </div>
                                            ...
                                            <table class="table align-middle">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-secondary fw-medium text-end">$0.00</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>Coupon Charge :</td>
                                                        <td class="text-secondary text-end">$0.00</td>
                                                    </tr>
                                                    <tr>
