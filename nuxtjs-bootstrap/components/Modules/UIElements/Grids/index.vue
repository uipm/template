    ...
    <div class="col-lg-12">
      <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
          <h4 class="fs-18 mb-4">Large Grid-Example</h4>
            ...
            >
              <div class="row">
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                  <div
                    class="bg-primary bg-opacity-10 p-5 rounded-3 text-center"
                  >
    ...
    <div class="col-lg-12">
      <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4 pb-0">
          <h4 class="fs-18 mb-4">Mid Grid-Example</h4>
            ...
            >
              <div class="row">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                  <div
                    class="bg-primary bg-opacity-10 p-5 rounded-3 text-center mb-4"
                  >
...
&lt;/div&gt;
    ...
    <div class="col-lg-12">
      <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4 pb-0">
          <h4 class="fs-18 mb-4">Three Grid-Example</h4>
              ...
              <div class="row">
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4">
                  <div
                    class="bg-primary bg-opacity-10 p-5 rounded-3 text-center mb-4"
                  >
                    <p>col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4</p>
                  </div>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4">
                  <div
...
&lt;/div&gt;
    ...
    <div class="col-lg-12">
      <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4 pb-0">
          <h4 class="fs-18 mb-4">Four Grid-Example</h4>
...
&lt;/div&gt;
    ...
    <div class="col-lg-12">
      <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4 pb-0">
          <h4 class="fs-18 mb-4">Twelve Grid-Example</h4>
          ...
          <div class="tab-content" id="myTabContent5">
            ...
            >
              <div class="row">
                <div class="col">
                  <div
                    class="bg-primary bg-opacity-10 p-3 rounded-3 text-center mb-4"
                  >
                    <p>col</p>
                  </div>
                </div>
