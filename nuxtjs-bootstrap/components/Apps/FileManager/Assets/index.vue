    ...
    <div class="col-xxl-3 col-xl-6 col-sm-6">
      <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
          ...
          <div class="d-flex align-items-center py-4 my-3">
            <i class="material-symbols-outlined fs-45 text-danger"
              >folder_open</i
            >
            <span
              class="fs-15 fw-bold text-secondary ms-2 position-relative top-2"
    ...
    <div class="col-xxl-3 col-xl-6 col-sm-6">
      <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
          ...
          <div class="d-flex align-items-center py-4 my-3">
            <i class="material-symbols-outlined fs-45 text-warning"
              >folder_open</i
            >
            <span
              class="fs-15 fw-bold text-secondary ms-2 position-relative top-2"
    ...
    <div class="col-xxl-3 col-xl-6 col-sm-6">
      <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
          ...
          <div class="d-flex align-items-center py-4 my-3">
            <i class="material-symbols-outlined fs-45 text-secondary"
              >folder_open</i
            >
            <span
              class="fs-15 fw-bold text-secondary ms-2 position-relative top-2"
    ...
    <div class="col-xxl-3 col-xl-6 col-sm-6">
      <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
          ...
          <div class="d-flex align-items-center py-4 my-3">
            <i
              class="material-symbols-outlined fs-45 text-warning text-opacity-10"
              >folder_open</i
            >
            <span
              class="fs-15 fw-bold text-secondary ms-2 position-relative top-2"
