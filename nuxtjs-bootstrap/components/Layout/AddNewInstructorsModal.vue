<template>
  <div
    ...
    tabindex="-1"
    id="addNewInstructorsModal"
    aria-labelledby="addNewInstructorsModalLabel"
  >
    <div class="offcanvas-header border-bottom p-4">
      <h5 class="offcanvas-title fs-18 mb-0" id="addNewInstructorsModalLabel">
        Add New Instructors
      </h5>
      <button
        type="button"
