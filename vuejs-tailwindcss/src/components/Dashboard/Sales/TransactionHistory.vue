<template>
  ...
  >
    ...
    <div class="trezo-card-content">
      <ul>
        <li
          class="flex items-center justify-between mb-[15px] md:mb-[18px] lg:mb-[26px] last:mb-0"
        >
          <div class="flex items-center">
            ...
            <div>
              ...
              <span class="block text-sm"> 16 Jun 2024 - 7:12 pm </span>
            </div>
          </div>
          <span class="block text-success-600"> +1,520 </span>
        </li>
        <li
          class="flex items-center justify-between mb-[15px] md:mb-[18px] lg:mb-[26px] last:mb-0"
        >
          <div class="flex items-center">
            ...
            <div>
              ...
              <span class="block text-sm"> 15 Jun 2024 - 1:42 am </span>
            </div>
          </div>
          <span class="block text-danger-500"> -2,250 </span>
        </li>
        <li
          class="flex items-center justify-between mb-[15px] md:mb-[18px] lg:mb-[26px] last:mb-0"
        >
          <div class="flex items-center">
            ...
            <div>
              ...
              <span class="block text-sm"> 14 Jun 2024 - 4:21 pm </span>
            </div>
          </div>
          <span class="block text-success-600"> +3,560 </span>
        </li>
        <li
          class="flex items-center justify-between mb-[15px] md:mb-[18px] lg:mb-[26px] last:mb-0"
        >
          <div class="flex items-center">
            ...
            <div>
              ...
              <span class="block text-sm"> 13 Jun 2024 - 2:42 am </span>
            </div>
          </div>
          <span class="block text-success-600"> +6,500 </span>
        </li>
        <li
          class="flex items-center justify-between mb-[15px] md:mb-[18px] lg:mb-[26px] last:mb-0"
        >
          <div class="flex items-center">
            ...
            <div>
              ...
              <span class="block text-sm"> 12 Jun 2024 - 3:20 pm </span>
            </div>
          </div>
          <span class="block text-danger-500"> -4,320 </span>
        </li>
        <li
          class="flex items-center justify-between mb-[15px] md:mb-[18px] lg:mb-[26px] last:mb-0"
        >
          <div class="flex items-center">
            ...
            <div>
              ...
              <span class="block text-sm"> 16 Dec 2024 - 1:23 pm </span>
            </div>
          </div>
          <span class="block text-success-600"> +5,432 </span>
        </li>
        <li
          class="flex items-center justify-between mb-[15px] md:mb-[18px] lg:mb-[26px] last:mb-0"
        >
          <div class="flex items-center">
            ...
            <div>
              ...
              <span class="block text-sm"> 23 Dec 2024 - 3:20 pm </span>
            </div>
          </div>
          <span class="block text-success-600"> +1,820 </span>
        </li>
      </ul>
    </div>
  </div>
