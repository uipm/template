  ...
  >
    ...
    >
      <div class="trezo-card-title">
        <h5 class="mb-0 font-semibold">Employee Leave Request</h5>
      </div>
    ...
    <div class="trezo-card-content -mx-[20px] md:-mx-[25px]">
      <div class="table-responsive overflow-x-auto">
        <table class="w-full">
          <thead>
            <tr>
              <th
                class="font-normal border-t border-gray-100 dark:border-[#172036] ltr:text-left rtl:text-right px-[20px] py-[12px] md:ltr:first:pl-[25px] md:rtl:first:pr-[25px] ltr:first:pr-0 rtl:first:pl-0 whitespace-nowrap"
              >
                Employee
              </th>
              <th
              ...
              >
                <div class="flex items-center gap-[10px]">
                  <div class="rounded-full w-[40px]">
                    <img
                      src="@/assets/images/users/user42.jpg"
            ...
            <tr>
              ...
              >
                <div class="flex items-center gap-[10px]">
                  <div class="rounded-full w-[40px]">
                    <img
                      src="@/assets/images/users/user41.jpg"
                      class="inline-block rounded-full"
                      alt="product-image"
                    />
                  </div>
              ...
              >
                <span
                  class="px-[8px] py-[3px] inline-block font-medium bg-purple-100 dark:bg-[#15203c] text-purple-700 rounded-sm text-xs"
                >
                  Pending
                </span>
              </td>
            ...
            <tr>
              ...
              >
                <div class="flex items-center gap-[10px]">
                  <div class="rounded-full w-[40px]">
                    <img
                      src="@/assets/images/users/user44.jpg"
                      class="inline-block rounded-full"
                      alt="product-image"
                    />
                  </div>
      ...
      <Pagination items="5" total="30" class="px-[20px] md:px-[25px]" />
    </div>
  </div>
</template>
