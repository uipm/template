      ...
      <div class="table-responsive overflow-auto h-[426px]">
        <table class="w-full">
          ...
          <tbody class="text-black dark:text-white">
            <tr>
              <td
                class="text-gray-500 dark:text-gray-400 ltr:text-left rtl:text-right whitespace-nowrap px-[20px] py-[15px] md:ltr:first:pl-[25px] md:rtl:first:pr-[25px] ltr:first:pr-0 rtl:first:pl-0 border-b border-gray-100 dark:border-[#172036]"
              >
                #A-1217
              </td>
              <td
              ...
              >
                <div class="flex items-center">
                  <img
                    ...
                    class="inline-block rounded-full w-[44px]"
                    alt="product-image"
                  />
                  <span
                    class="font-medium inline-block ltr:ml-[12px] rtl:mr-[12px]"
                  >
                    Olivia Clark
                  </span>
                </div>
