        ...
        <table class="w-full">
          <thead class="text-black dark:text-white">
            <tr>
              ...
              <th
                class="font-medium ltr:text-right rtl:text-left px-[20px] py-[11px] md:ltr:first:pl-[25px] md:rtl:first:pr-[25px] ltr:first:pr-0 rtl:first:pl-0 bg-primary-50 dark:bg-[#15203c] whitespace-nowrap"
              >
                Action
              </th>
            </tr>
          ...
          <tbody class="text-black dark:text-white">
            <tr>
              ...
              >
                <div
                  class="flex items-center leading-none gap-[2px] text-[#fe7a36] text-[15px]"
                >
              ...
              <td
                class="ltr:text-right rtl:text-left whitespace-nowrap px-[20px] py-[17px] md:ltr:first:pl-[25px] md:rtl:first:pr-[25px] ltr:first:pr-0 rtl:first:pl-0 border-b border-gray-100 dark:border-[#172036]"
              >
                <button
                  type="button"
            ...
            <tr>
              ...
              >
                <div class="flex items-center">
                  ...
                  <div>
                    <span class="block font-medium"> Ava Turner </span>
                    <span class="text-gray-500 dark:text-gray-400 block mt-px">
                      UX/UI
                    </span>
                  </div>
            ...
            <tr>
              ...
              >
                <div class="flex items-center">
                  ...
                  <div>
                    <span class="block font-medium"> Lucas Morgan </span>
                    <span class="text-gray-500 dark:text-gray-400 block mt-px">
                      Developer
                    </span>
                  </div>
            ...
            <tr>
              ...
              >
                <div class="flex items-center">
                  ...
                  <div>
                    <span class="block font-medium"> Isabella Cooper </span>
                    <span class="text-gray-500 dark:text-gray-400 block mt-px">
                      Designer
                    </span>
                  </div>
