  ...
  >
    <div class="trezo-tabs products-tabs" id="trezo-tabs">
      <ul class="products-list-navs mb-[10px] md:mb-[15px]">
        <li
          class="nav-item inline-block mb-[10px] ltr:mr-[11px] rtl:ml-[11px] ltr:last:mr-0 rtl:last:ml-0"
        >
          <button
            type="button"
            class="nav-link block font-semibold transition-all rounded-md text-black dark:text-white py-[10px] md:py-[12px] px-[22px] md:px-[30px] bg-gray-50 dark:bg-[#15203c]"
            :class="['tab', { active: activeTab === 'allProducts' }]"
        ...
        >
          <button
            type="button"
            class="nav-link block font-semibold transition-all rounded-md text-black dark:text-white py-[10px] md:py-[12px] px-[22px] md:px-[30px] bg-gray-50 dark:bg-[#15203c]"
            :class="['tab', { active: activeTab === 'publishedProducts' }]"
            @click="setActiveTab('publishedProducts')"
          >
            Published Products
          </button>
        </li>
        ...
        >
          <button
            type="button"
            class="nav-link block font-semibold transition-all rounded-md text-black dark:text-white py-[10px] md:py-[12px] px-[22px] md:px-[30px] bg-gray-50 dark:bg-[#15203c]"
            :class="['tab', { active: activeTab === 'draftProducts' }]"
            @click="setActiveTab('draftProducts')"
          >
            Draft Products
          </button>
        </li>
