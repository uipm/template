<template>
    ...
    >
        <div class="realtime-active-users-card-content">
            ...
            <span class="d-block sub-title text-white">
            ...
            <div class="shape">
                <v-img src="/images/shape.png" alt="shape" />
            </div>
        </div>
    </v-card>
</template>
        ...
        const users = ref([
            {
                name: "Users",
                data: [
                    100, 90, 85, 95, 100, 100, 90, 85, 95, 100, 100, 90, 85, 95,
                    100, 100, 90, 85, 95, 100, 100, 90, 85, 95, 100, 100, 90,
                    85, 95, 100,
                ],
            },
        ]);
