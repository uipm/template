    ...
    <div class="trezo-card-content">
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          ...
          <span
            class="inline-block px-[8.3px] py-[1px] text-success-700 border border-success-300 bg-success-100 text-sm ltr:ml-[10px] rtl:mr-[10px] rounded-[100px]"
          >
            +10%
          </span>
        </div>
      ...
      <h5 class="text-[18px] md:text-[20px] mb-0 mt-[4px]">$165,458</h5>
      <div
