    ...
    <div class="lg:col-span-2">
      ...
      >
        ...
        <div class="trezo-card-content">
          ...
          <span class="block mb-[10px] last:mb-0"> Date: 26 Mar 2024 </span>
          <div
            class="my-[25px] md:my-[45px] md:flex z-[1] relative justify-between"
          >
            <span
              class="block absolute bottom-0 md:bottom-auto ltr:left-[25px] ltr:md:left-0 ltr:md:right-0 rtl:right-[25px] rtl:md:right-0 rtl:md:left-0 top-[25px] -z-[1] border-t border-dashed border-primary-500 ltr:border-l ltr:md:border-l-0 rtl:border-l rtl:md:border-l-0"
            ></span>
            <div>
              <div
                class="rounded-full text-center font-semibold text-black dark:text-white w-[50px] h-[50px] leading-[48px] bg-white dark:bg-[#0c1427] border border-dashed border-primary-500"
              >
                01
              </div>
              <span
                class="block text-md mt-[17px] font-semibold text-black dark:text-white ltr:pl-[45px] rtl:pr-[45px] md:!p-0"
              >
                Order Placed
              </span>
              <span
                class="block mb-[15px] md:mb-0 mt-[7px] ltr:pl-[45px] rtl:pr-[45px] md:!p-0"
              >
                22 Mar 2024 - 11:35AM
              </span>
            </div>
            ...
            <div>
              <div
                class="rounded-full text-center font-semibold text-white w-[50px] h-[50px] leading-[48px] bg-primary-500 border border-dashed border-primary-500"
              >
                04
              </div>
              <span
          ...
          <span
            class="block font-semibold text-black dark:text-white mb-[10px] last:mb-0"
          >
            View Details:
          </span>
          <span class="block mb-[10px] last:mb-0">
            ...
            <span class="text-black dark:text-white"
              >Your order delivered.</span
            >
          </span>
          <span class="block mb-[10px] last:mb-0">
            24 Mar 2024 - 3:45PM:
            <span class="text-black dark:text-white">Your order shipped.</span>
          </span>
          <span class="block mb-[10px] last:mb-0">
            23 Mar 2024 - 10:35AM:
            <span class="text-black dark:text-white"
              >Your order is on the way for deliver.</span
            >
          </span>
          <span class="block mb-[10px] last:mb-0">
            22 Mar 2024 - 11:35AM:
