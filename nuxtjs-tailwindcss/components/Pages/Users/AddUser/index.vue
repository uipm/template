        ...
        >
          ...
          <div class="trezo-card-content">
            <div class="mb-[20px] sm:mb-[25px]">
              <div
                class="form-check flex items-center gap-[8px] mb-[10px] last:mb-0"
              >
                <input
                  type="checkbox"
              ...
              >
                ...
                />
                <label
                  for="allowUsersToShowYourExperiences"
                  class="cursor-pointer"
                >
              ...
              >
                ...
                />
                <label
                  for="allowUsersToShowYourFollowers"
                  class="cursor-pointer"
                >
